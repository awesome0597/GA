...
DF = pd.DataFrame(columns=['Calls to fitness', 'Generation', 'Best Fitness', 'Best Individual', 'Word Percentage', 'local minimas'])
...
def crossover(parent1, parent2):
    ...
    # might be worth mixing up the order of the keys to avoid bias
...
class GeneticAlgorithm:
    ...
    def _mutate(self, individual):
        ...
        if random.random() < self.mutation_rate:
            ...
            mutated_individual[key1], mutated_individual[key2] = individual[key2], individual[key1]
    ...
    def run(self):
        ...
        while generations < 200 and local_minima <= 10 and self.population[0]['word_percent'] < target_word_percentage:
            self.evolve()
